CUDA_VISIBLE_DEVICES=2 fairseq-train PATH TO/copticmt/CopEng/FairSEQ/M2M100/coptic2english.coptic-en \
  ...
  --ddp-backend no_c10d \
  --max-epoch 10 \
  --wandb-project "Coptic 2 English M2M100" >>  PATH TO/copticmt/CopEng/FairSEQ/M2M100/coptic2english.log