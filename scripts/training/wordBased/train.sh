...
SOURCE_LANGUAGE="en"
TARGET_LANGUAGE="coptic"
LABEL_SMOOTHING=0.1
SAVE_DIR="PATH TO/coptic-translator/checkpointWordBasedPCM/English2CopticWordBasedSeq2SeqTransformer"
LABEL_CROSS_ENTROPY="label_smoothed_cross_entropy"
WARMUP_UPDATES=4000
lEARNING_POLICY="inverse_sqrt"
WAND_PROJECT_NAME="English to Coptic Translation Word Translation "
# name can contain only "_" as non characters

fairseq-train "PATH TO/coptic-translator/fairseqwordBased/en_coptic.tokenized.en-coptic"\
    --arch "transformer" \
    --dropout $DROPOUT \
