...
TARGET_LANGUAGE="en"
TRAIN_PREF="PATH TO/coptic-translator/dataPreperationForFairseqTrain/train"
VALID_PREF="PATH TO/coptic-translator/dataPreperationForFairseqTrain/val"
TEST_PREF="PATH TO/coptic-translator/dataPreperationForFairseqTrain/test"
COPTIC_EN_DEST_DIR="PATH TO/coptic-translator/fairseqwordBased/coptic_en.tokenized.coptic-en"
EN_COPTIC_DEST_DIR="PATH TO/coptic-translator/fairseqwordBased/en_coptic.tokenized.en-coptic"
SRC_THRES=0
TGT_THRES=0
