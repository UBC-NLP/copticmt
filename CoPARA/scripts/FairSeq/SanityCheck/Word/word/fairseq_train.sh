...
TARGET_LANGUAGE=ar
LABEL_SMOOTHING=0.1
SAVE_DIR=PATH TO/coptic-translator/fairseqCheckpoints/sanityCheck/
...
fairseq-train "PATH TO/coptic-translator/fairseqCheckpointsCoPAra/sanityCheck/coptic_en.tokenized.coptic-en" \
    --arch transformer \
    --dropout $DROPOUT \
